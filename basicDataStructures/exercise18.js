// Iterate Through the Keys of an Object with a for...in Statement - exercise 18
...
iteration to each of the object's keys as the statement looped through the object, 
...
>We've defined a function countOnline which accepts one argument (a users object). Use a for...in statement 
within this function to loop through the users object passed into the function and return the number of users 
whose online property is set to true. An example of a users object which could be passed to countOnline is shown below. 
