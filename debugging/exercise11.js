// Use Caution When Reinitializing Variables Inside a Loop - exercise 11
...
Unfortunately, it's not producing the expected output because the row variable isn't being reinitialized (set back to an empty array) 
