// Use an IIFE to Create a Module - exercise 26
...
The advantage of the module pattern is that all of the motion behaviors can be packaged into a single object that can then 
