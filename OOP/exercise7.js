// Extend Constructors to Receive Arguments - exercise 7
// @Author Benites, Matias M. 2022

/* 
The Bird and Dog constructors from the last challenge worked well. However, notice that all Birds that are created with 
the Bird constructor are automatically named Albert, are blue in color, and have two legs. 
...
his gives a new instance of Bird with name and color properties set to Bruce and red, respectively. 
...
let terrier = new Dog("Paco", "Black");
