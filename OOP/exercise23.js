// Use a Mixin to Add Common Behavior Between Unrelated Objects - exercise 23
...
>Create a mixin named glideMixin that defines a method named glide. Then use the glideMixin to give both bird and 
boat the ability to glide.
let bird = {
  name: "Donald",
  numLegs: 2
};
