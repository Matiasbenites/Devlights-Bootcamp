// Create a Basic JavaScript Object - exercise 1
...
but may have different values for those properties. For example, all cars have wheels, but not all cars have the same number of wheels.
