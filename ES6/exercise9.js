// Use Destructuring Assignment to Extract Values from Objects - exercise 9
...
Replace the two assignments with an equivalent destructuring assignment. It should still assign the variables today and tomorrow the values 
