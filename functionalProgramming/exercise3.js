// Understand the Hazards of Using Imperative Code - exercise 3
...
computer should perform them. For example, instead of using the for loop mentioned above, 
...
The titles of each open site in each Window object is held in an array. After working in the browser (opening new tabs, merging windows, and closing tabs), you want to print the tabs that are still open. Closed tabs are removed from the array and new tabs (for simplicity) get added to the end of it.
