// Use Higher-Order Functions map, filter, or reduce to Solve a Complex Problem - exercise 16
...
const squareList = (arr) => {
  return arr
    .filter((intNum) => intNum > 0 && intNum % parseInt(intNum) === 0)
    .map((intNum) => Math.pow(intNum, 2));
};
