// Use the reduce Method to Analyze Data - exercise 15
...
The reduce method allows for more general forms of array processing, and it's possible to show that both filter 
and map can be derived as special applications of reduce. 
...
If this second parameter is not used, then the first iteration is skipped and the second iteration gets passed the first element
...
function getRating(watchList) {
  ...
  const averageRating =
    watchList
      ...
      .reduce((sum, ratings) => sum + ratings) /
